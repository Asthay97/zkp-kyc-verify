...
// import VerifyProof from './components/VerifyProof' // New component for proof verification

interface VerifierProps {}

const Verifier: React.FC<VerifierProps> = () => {
    ...
    <div className="hero min-h-screen bg-black flex justify-center items-center">
      <div className="hero-content text-center rounded-lg p-10 max-w-lg bg-white shadow-lg">
        <div className="max-w-lg">
          <h1 className="text-2xl font-bold">KYC Verification - VERIFIER</h1>
        ...
        {/* <VerifyProof openModal={verifyProofModal} closeModal={() => setVerifyProofModal(false)} /> */}
      </div>
      </div>
    </div>
  )
